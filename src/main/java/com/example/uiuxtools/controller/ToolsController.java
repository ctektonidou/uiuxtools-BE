...
@RestController //Combines @Controller and @ResponseBody, indicating that the controller returns data (e.g., JSON) directly instead of rendering a view.
@RequestMapping("/api/tools") //Sets the base URL for all endpoints in this controller, e.g., http://localhost:8080/api/tools
